require 'rubygems/defaults/support/vendor_gem_source_index'
...
module Rails
  class GemDependency < Gem::Dependency
    ...
    def self.unpacked_path
      @unpacked_path ||= File.join(Dir.pwd, 'vendor', 'gems')
    end
    ...
    def build
      require 'rubygems/defaults/support/rails_gem_builder'
      unless built?
